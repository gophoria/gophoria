...
model Post {
  ...
  authorId  int
	...
	expected := []*lexer.Token{
		...
		lexer.NewToken(lexer.TokenTypeTString, "string", 0, 0),
		lexer.NewToken(lexer.TokenTypeDecorator, "@", 0, 0),
		lexer.NewToken(lexer.TokenTypeIdent, "id", 0, 0),
		lexer.NewToken(lexer.TokenTypeDecorator, "@", 0, 0),
		lexer.NewToken(lexer.TokenTypeIdent, "default", 0, 0),
		...
		lexer.NewToken(lexer.TokenTypeTString, "string", 0, 0),
		lexer.NewToken(lexer.TokenTypeDecorator, "@", 0, 0),
		lexer.NewToken(lexer.TokenTypeIdent, "nullable", 0, 0),
		...
		lexer.NewToken(lexer.TokenTypeIdent, "User", 0, 0),
		lexer.NewToken(lexer.TokenTypeDecorator, "@", 0, 0),
		lexer.NewToken(lexer.TokenTypeIdent, "relation", 0, 0),
		lexer.NewToken(lexer.TokenTypeLParen, "(", 0, 0),
